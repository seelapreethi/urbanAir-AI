  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-ink-secondary mt-1">
            Global system configurations, user management, and sensor calibration metrics.
          </p>
        </div>
        <div>
          <Badge variant="danger">Administrator Only</Badge>
        </div>
      </div>
      ...
      <div className="border border-border bg-surface rounded-xl p-8 min-h-[500px] flex flex-col items-center justify-center text-center relative overflow-hidden">
        ...
        <div className="w-16 h-16 rounded-xl bg-danger/10 border border-danger/20 flex items-center justify-center text-danger mb-6 z-10">
        ...
        <p className="text-sm text-ink-secondary max-w-md mx-auto leading-relaxed mb-6 z-10">
          Sensor connectivity calibration gates, role privilege configuration adjustments, and user account creation logs will mount here in future updates.
        </p>
